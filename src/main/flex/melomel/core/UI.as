...
public class UI
{
	 ...
	 *
	 *	@param component  A data control which has an itemToLabel() method.
	 *	@param data       The dataset to generate labels from.
	 *	@param column     The column to generate labels from. (Optional)
	 *
	 *	@return           A list of labels generated by the component.
	 */
	static public function itemsToLabels(component:Object, data:Object,
										 column:Object=null):Array
	{
